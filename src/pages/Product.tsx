          ...
          <article className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <Badge className="bg-[hsl(var(--shipping-green))] text-white hover:bg-[hsl(var(--shipping-green))]/90 font-medium px-3 py-1 text-sm" style={{borderRadius: '999px'}}>Envio Full Armazenaí</Badge>
                <Badge className="bg-[hsl(var(--shipping-blue))] text-white hover:bg-[hsl(var(--shipping-blue))]/90 font-medium px-3 py-1 text-sm" style={{borderRadius: '999px'}}>Frete Same-Day Disponível</Badge>
                <Badge className="bg-[hsl(var(--shipping-orange))] text-white hover:bg-[hsl(var(--shipping-orange))]/90 font-medium px-3 py-1 text-sm" style={{borderRadius: '999px'}}>Frete Next-Day Disponível</Badge>
              </div>
