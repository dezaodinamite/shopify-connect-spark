...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const desc = "Bebidas de jabuticaba naturalmente antioxidantes. Compre online.";
  ...
  return <main className="min-h-screen bg-background">
      ...
      <section id="produtos" className="container mx-auto py-16 px-4 md:py-20">
        ...
        {loading ? <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
            {Array.from({
          length: 3
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src="/lovable-uploads/afd87f4b-f8d6-4012-8360-6bcc57920347.png" alt="Consumidora apresentando a bebida Suívie Jabuticaba" className="radius-lg" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative md:order-2 order-2">
              <img src="/lovable-uploads/13500a28-1b95-404c-b935-d463f3030c4e.png" alt="Jabuticabas - super fruta rica em antioxidantes" className="radius-lg" loading="lazy" />
            </div>
